...
void Xicro::begin(__UART_TYPE *SerialObject){
    ...
    // gen_void_begin
    // gen pointer sub    _nonverify[0][0][0]=&_Subscription_thumb_finger_L.message.data;    _nonverify[1][0][0]=&_Subscription_index_finger_L.message.data;    _nonverify[2][0][0]=&_Subscription_middle_finger_L.message.data;    _nonverify[3][0][0]=&_Subscription_ring_finger_L.message.data;    _nonverify[4][0][0]=&_Subscription_pinky_finger_L.message.data;    _nonverify[5][0][0]=&_Subscription_bicep_L.message.data;    _nonverify[6][0][0]=&_Subscription_rotate_L.message.data;    _nonverify[7][0][0]=&_Subscription_shoulder_L.message.data;    _nonverify[8][0][0]=&_Subscription_omoplate_L.message.data;    _verify[0][0][0]=&Subscription_thumb_finger_L.message.data;    _verify[1][0][0]=&Subscription_index_finger_L.message.data;    _verify[2][0][0]=&Subscription_middle_finger_L.message.data;    _verify[3][0][0]=&Subscription_ring_finger_L.message.data;    _verify[4][0][0]=&Subscription_pinky_finger_L.message.data;    _verify[5][0][0]=&Subscription_bicep_L.message.data;    _verify[6][0][0]=&Subscription_rotate_L.message.data;    _verify[7][0][0]=&Subscription_shoulder_L.message.data;    _verify[8][0][0]=&Subscription_omoplate_L.message.data;    // gen pointer srv client res    // gen pointer srv server req    // gen pointer action client feed    // gen pointer action server req  
