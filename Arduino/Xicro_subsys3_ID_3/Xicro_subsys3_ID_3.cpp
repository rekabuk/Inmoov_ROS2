...
void Xicro::begin(__UART_TYPE *SerialObject){
    ...
    // gen_void_begin
    // gen pointer sub    _nonverify[0][0][0]=&_Subscription_head_rot.message.data;    _nonverify[1][0][0]=&_Subscription_jaw.message.data;    _nonverify[2][0][0]=&_Subscription_eyey.message.data;    _nonverify[3][0][0]=&_Subscription_eyex_l.message.data;    _nonverify[4][0][0]=&_Subscription_eyex_r.message.data;    _nonverify[5][0][0]=&_Subscription_head_front.message.data;    _nonverify[6][0][0]=&_Subscription_head_rear.message.data;    _verify[0][0][0]=&Subscription_head_rot.message.data;    _verify[1][0][0]=&Subscription_jaw.message.data;    _verify[2][0][0]=&Subscription_eyey.message.data;    _verify[3][0][0]=&Subscription_eyex_l.message.data;    _verify[4][0][0]=&Subscription_eyex_r.message.data;    _verify[5][0][0]=&Subscription_head_front.message.data;    _verify[6][0][0]=&Subscription_head_rear.message.data;    // gen pointer srv client res    // gen pointer srv server req    // gen pointer action client feed    // gen pointer action server req  
